...
namespace Inferno {
	...
	SoftmaxBackward::SoftmaxBackward(const Tensor& A, const Tensor& out) : m_A(A), m_out(out) {
	...
	void SoftmaxBackward::backward() {
		...
		Tensor g_a = dispatchTwo(m_out.dtype(), g_out.dtype(), [&](auto TA, auto TG) {
			...
			case DeviceType::CPU:
				...
				//cpu_softmax_backward(aptr, gptr, optr, out.numel());
			...
			case DeviceType::CUDA:
				...
				//cuda_softmax_backward<AT, GT, RT>(aptr, gptr, optr, out.numel());
				break;
