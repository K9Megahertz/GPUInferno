...
namespace Inferno {
	...
	__global__ void select_backward_kernel(
		...
		optr[pidx] = static_cast<RT>(gptr[gidx]);
	}
	...
	void cuda_select_backward_strided(
		...
		select_backward_kernel<GT, RT> << <blocks, threads >> > (
			gptr, optr,
	...
	template void cuda_select_backward_strided<float, float>(
		const float*, float*,
	...
	template void cuda_select_backward_strided<double, double>(
		const double*, double*,
		const std::vector<size_t>&,
		const std::vector<size_t>&,
		const std::vector<size_t>&,
	...
	template void cuda_select_backward_strided<float, double>(
		const float*, double*,
		const std::vector<size_t>&,
		const std::vector<size_t>&,
		const std::vector<size_t>&,
	...
	template void cuda_select_backward_strided<double, float>(
		const double*, float*,
		const std::vector<size_t>&,
		const std::vector<size_t>&,
		const std::vector<size_t>&,
	...
	template void cuda_select_backward_strided<int, float>(
		const int*, float*,
		const std::vector<size_t>&,
		const std::vector<size_t>&,
		const std::vector<size_t>&,
	...
	template void cuda_select_backward_strided<int, double>(
		const int*, double*,
		const std::vector<size_t>&,
		const std::vector<size_t>&,
		const std::vector<size_t>&,
	...
	template void cuda_select_backward_strided<int, int>(
		const int*, int*,
		const std::vector<size_t>&,
		const std::vector<size_t>&,
		const std::vector<size_t>&,
